...
class ASVDataset(Dataset):
    ...
    def __init__(self, database_path=None,protocols_path=None,transform=None, 
        ...
        self.protocols_fname = 'eval.trl' if is_eval else 'train.trl' if is_train else 'dev.trl'
        ...
        self.cache_fname = '{}_{}_{}.npy'.format(self.dset_name,track,feature_name)
        ...
        if os.path.exists(self.cache_fname):
            ...
            # print('files_meata',self.files_meta)
...
if __name__ == '__main__':
    ...
    train_set = ASVDataset(database_path='/data2/tzc/LA/', protocols_path='/data2/tzc/LA/ASVspoof2019_LA_cm_protocols/',
                                     is_train=True, is_logical=True, transform=transforms,
                                     feature_name='Raw_audio')
    train_loader = DataLoader(train_set, batch_size=32, shuffle=True)
    for batch_x, batch_y, batch_meta in train_loader:
        # batch_x, batch_y, batch_meta = train_set
        print('x.shape',batch_x.shape)
        print('y.shape',batch_y.shape)
    # print('meta.shape',batch_meta)
