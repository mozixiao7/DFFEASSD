...
class ASVspoof2021evalRaw(Dataset):
    def __init__(self, path_to_database="/data2/tzc/LA/ASVspoof2019_LA_eval/flac"):
...
class ASVspoof2019LARaw_withTransmission(Dataset):
    def __init__(self, path_to_database="/data/shared/LA_aug", path_to_protocol="/data2/tzc/LA/ASVspoof2019_LA_cm_protocols/", part='train'):
...
class ASVspoof2019LARaw_withTransmissionAndDevice(Dataset):
    def __init__(self, path_to_database="/data/shared/LAPA_aug", path_to_protocol="/data2/tzc/LA/ASVspoof2019_LA_cm_protocols/", part='train'):
        ...
        self.label = {"spoof": 1, "bonafide": 0}
        self.all_files = librosa.util.find_files(self.path_to_audio, ext="wav")
        print('all_files',len(self.all_files))
...
class ASVspoof2019DFRaw_withCompression(Dataset):
    def __init__(self, path_to_database="/data/shared/DF_aug", path_to_protocol="/data2/tzc/LA/ASVspoof2019_LA_cm_protocols/", part='train'):
...
if __name__ == "__main__":
    ...
    #     # print('asvspoof2021Raw_LAPA_aug',len(asvspoof2021Raw_LAPA_aug))
    ...
    #     # print(device_lst)
    training_set = ASVspoof2019Raw(access_type='LA', path_to_database='/data2/tzc/',
